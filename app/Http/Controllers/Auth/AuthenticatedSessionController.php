    ...
    public function sendOtp(Request $request): RedirectResponse
    {
        ...
        if (
            ...
            return back()
                ...
                ->withErrors([
                    'email' =>
                        "Terlalu banyak permintaan kode. Coba lagi dalam {$seconds} detik.",
                ]);
        }
        ...
        if (
            ...
            return back()
                ...
                ->withErrors([
                    'email' =>
                        'Kode sudah dikirim. Tunggu 60 detik sebelum meminta kode baru.',
                ]);
        }
        ...
        try {
            ...
            return back()
                ...
                ->withErrors([
                    'email' =>
                        'Gagal mengirim kode verifikasi. Periksa konfigurasi email aplikasi.',
                ]);
        }
    ...
    public function verifyOtp(
        ...
        if (
            ...
            return back()->withErrors([
                'code' =>
                    "Terlalu banyak percobaan. Coba lagi dalam {$seconds} detik atau kirim kode baru.",
            ]);
        }
