...
Route::view('/syarat-ketentuan', 'pages.syarat-ketentuan')->name('terms');
Route::view('/kebijakan-privasi', 'pages.kebijakan-privasi')->name('privacy');
...
Route::middleware(['customer', 'no-cache'])->group(function () {
    Route::get('/session/csrf-token', [AuthenticatedSessionController::class, 'csrfToken'])->name('session.csrf');
    ...
    Route::get('/transaksi/{id}', [CustomerTransaksiController::class, 'show'])
        ->whereNumber('id')
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin', 'no-cache'])->group(function () {
        ...
        Route::get('/transaksi/{id}', [AdminTransaksiController::class, 'show'])
            ->whereNumber('id')
            ->name('transaksi.show');
        Route::post('/transaksi/{id}/approve', [AdminTransaksiController::class, 'approve'])
            ->whereNumber('id')
        ...
        Route::get('/pengembalian/{kode}', [AdminTransaksiController::class, 'detailPengembalian'])
