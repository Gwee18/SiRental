...
@section('content')
    ...
    <div class="max-w-3xl">
        ...
        <a href="{{ route('admin.transaksi.index') }}" class="inline-flex items-center gap-1.5 text-[#085041] hover:text-[#00372c] text-sm font-semibold mb-6 transition-colors">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-4">
            <div class="flex flex-wrap items-start justify-between gap-4 mb-6 pb-6 border-b border-gray-100">
                <div>
                    <h2 class="text-xl font-bold text-[#00372c] mb-1">
                        {{ $transaksi->kode_transaksi }}
                    </h2>
                    <p class="text-gray-400 text-sm">
                        Dipesan {{ $transaksi->created_at->translatedFormat('d F Y, H:i') }}
                    </p>
                </div>
            ...
            <div class="space-y-3 mb-6">
                @foreach($transaksi->detailTransaksi as $detail)
                    <div class="flex items-center justify-between bg-gray-50 rounded-xl px-4 py-3">
                        <div class="flex items-center gap-3">
                            ...
                            @else
                                <div class="w-12 h-12 rounded-lg bg-[#e8f5f0] flex items-center justify-center">
                                    <svg width="24" height="24" fill="none" stroke="#085041" stroke-width="1.8" viewBox="0 0 24 24" class="opacity-50">
                            ...
                            <div>
                                <p class="font-semibold text-[#00372c] text-sm">
                        ...
                        <p class="font-bold text-[#085041] text-sm">
            ...
            <div class="space-y-2 pt-4 border-t border-gray-100">
                ...
                <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                    ...
                    <span class="font-bold text-[#085041] text-lg">
                        Rp {{ number_format($transaksi->total_harga + $transaksi->total_denda, 0, ',', '.') }}
                    </span>
                </div>
            </div>
        </div>
